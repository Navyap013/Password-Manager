...
const deletePassword = async (id) => {
  ...
  return (
    <>
      ...
      <div className="p-2 md:px-0 mx-auto w-full max-w-4xl text-black">
        ...
        <p className="text-green-500 text-lg text-center text font-bold">
        ...
        <div className="text-white flex flex-col p-4 text-black gap-8 items-center">
          ...
          <button
            ...
            className="flex justify-center items-center text-black font-semibold bg-green-500 rounded-full px-8 py-2 w-fit hover:bg-green-300 gap-2 border border-3 border-green-800"
          >
             <lord-icon
